window.STOCK_DATA = {
  "meta": {
    "fetched_at": "2026-09-12 19:24",
    "sources": {
      "上市": "TWSE OpenAPI (openapi.twse.com.tw)",
      "上櫃": "櫃買中心 TPEx OpenAPI (tpex.org.tw)"
    },
    "errors": [
      "tpex_rev: <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1010)>",
      "tpex_price: <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1010)>"
    ],
    ...
    "8996": {
      ...
      "rev_history": [
        ...
        },
        {
          "month": "2026-07",
          "rev": 922.666,
          "yoy": 57.6339177410041,
          "mom": 27.305189115950366
        },
        {
          "month": "2026-08",
          "rev": 1203.933,
