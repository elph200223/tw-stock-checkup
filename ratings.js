  ...
  "rated": [
    {
      ...
      "subs": {
        ...
        "估值": [
          40,
          "PE>40 偏高,成長不如預期回檔風險大(PE 50.3);此為估值面,非買賣建議。"
        ],
        "動能": [
          100,
      ...
      "rev_month": "2026-06",
      "explain": {
        "summary": "台達電:本業有賺、財務還算穩,但有一兩個指標普通,月營收還在高速成長(最新月年增 55%),但目前股價偏貴(本益比 50 倍),等於先付了很多未來的成長;一旦成長不如預期,容易回檔。",
        "health": [
          {
            "name": "毛利率",
            "val": "36.3%",
        ...
        "valuation": "PE 50.3 偏高(>40),市場給很高成長期待;成長不如預期回檔會兇。 不過它月營收年增 55%、成長很快——高成長配高本益比未必真的貴,這要靠 PEG(本益成長比)判斷,目前資料還不夠算,先別只看 PE 就說太貴。",
  ...
  "unrated": [
    ...
    },
    {
      ...
      "subs": {
        ...
        "估值": [
          50,
          "虧損/獲利不穩,改看 PB:PB 3–6 偏高(PB 3.59)。"
        ],
        "動能": [
          85,
      ...
      "rev_month": "2026-06",
      "explain": {
        "summary": "臻鼎:部分體質指標資料不足,月營收還在高速成長(最新月年增 33%),由於獲利不穩,改用股價淨值比看:目前 3.6 倍(高,多在反映未來預期)。",
        "health": [],
        "valuation": "PB 3.59 >1,市場願為它的未來多付錢(高於帳面淨值),成長股常見,別追過頭。",
    ...
    },
    {
      ...
      "subs": {
        ...
        "估值": [
          35,
          "虧損/獲利不穩,改看 PB:PB>6 很高,多為未來預期(PB 18.82)。"
        ],
        "動能": [
          85,
      ...
      "rev_month": "2026-06",
      "explain": {
        "summary": "高力:部分體質指標資料不足,月營收還在高速成長(最新月年增 38%),由於獲利不穩,改用股價淨值比看:目前 18.8 倍(高,多在反映未來預期)。",
        "health": [],
        "valuation": "PB 18.82 >1,市場願為它的未來多付錢(高於帳面淨值),成長股常見,別追過頭。",
    ...
    },
    {
      ...
      "subs": {
        ...
        "估值": [
          50,
          "虧損/獲利不穩,改看 PB:PB 3–6 偏高(PB 5.67)。"
        ],
        "動能": [
          100,
      ...
      "rev_month": "2026-06",
      "explain": {
        "summary": "訊芯:部分體質指標資料不足,月營收還在高速成長(最新月年增 41%),由於獲利不穩,改用股價淨值比看:目前 5.7 倍(高,多在反映未來預期)。",
        "health": [],
        "valuation": "PB 5.67 >1,市場願為它的未來多付錢(高於帳面淨值),成長股常見,別追過頭。",
