  ...
  "rated": [
    {
      ...
      "explain": {
        ...
        "valuation": "PE 33.8 中高(25–40),已反映不少成長預期,進場挑時機。",
    ...
    },
    {
      ...
      "rev_month": "2026-05",
      "explain": {
        "summary": "台達電:本業有賺、財務還算穩,但有一兩個指標普通,月營收還在高速成長(最新月年增 44%),但目前股價偏貴(本益比 79 倍),等於先付了很多未來的成長;一旦成長不如預期,容易回檔。",
        "health": [
          {
            "name": "毛利率",
            "val": "37.0%",
        ...
        "valuation": "PE 79.3 偏高(>40),市場給很高成長期待;成長不如預期回檔會兇。 不過它月營收年增 44%、成長很快——高成長配高本益比未必真的貴,這要靠 PEG(本益成長比)判斷,目前資料還不夠算,先別只看 PE 就說太貴。",
    ...
    },
    {
      ...
      "rev_month": "2026-05",
      "explain": {
        "summary": "臻鼎:本業有賺、財務還算穩,但有一兩個指標普通,月營收還在高速成長(最新月年增 37%),但目前股價偏貴(本益比 88 倍),等於先付了很多未來的成長;一旦成長不如預期,容易回檔。",
        "health": [
          {
            "name": "毛利率",
            "val": "21.6%",
        ...
        "valuation": "PE 87.7 偏高(>40),市場給很高成長期待;成長不如預期回檔會兇。 不過它月營收年增 37%、成長很快——高成長配高本益比未必真的貴,這要靠 PEG(本益成長比)判斷,目前資料還不夠算,先別只看 PE 就說太貴。",
  ...
  "unrated": [
    {
      ...
      "explain": {
        ...
        "valuation": "PB 9.34 >1,市場願為它的未來多付錢(高於帳面淨值),成長股常見,別追過頭。",
