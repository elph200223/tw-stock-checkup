  ...
  "rated": [
    ...
    },
    {
      ...
      "subs": {
        ...
        "估值": [
          35,
          "虧損/獲利不穩,改看 PB:PB>6 很高,多為未來預期(PB 11.24)。"
        ],
        "動能": [
          25,
      ...
      "rev_month": "2026-05",
      "explain": {
        "summary": "上詮:賺錢能力或財務結構有明顯弱點,月營收在衰退(年增 -25%),動能踩煞車,由於獲利不穩,改用股價淨值比看:目前 11.2 倍(高,多在反映未來預期)。",
        "health": [
          {
            "name": "毛利率",
            "val": "1.9%",
        ...
        "valuation": "PB 11.24 >1,市場願為它的未來多付錢(高於帳面淨值),成長股常見,別追過頭。",
  ...
  "unrated": [
    {
      ...
      "blockers": [
        "pb(來源A 官方PB(BWIBBU)=15.7 / 來源B 股價÷每股淨值=16.5)"
      ],
      "verify_summary": {
        "price": "verified",
        "eps": "verified",
    ...
    },
    {
      ...
      "blockers": [
        "pb(來源A 官方PB(BWIBBU)=27.43 / 來源B 股價÷每股淨值=29.)"
      ],
      "verify_summary": {
        "price": "verified",
        "eps": "verified",
    ...
    },
    {
      ...
      "blockers": [
        ...
        "pb(來源A 官方PB(BWIBBU)=9.06 / 來源B 股價÷每股淨值=8.52)"
      ],
      "verify_summary": {
        "price": "verified",
        "eps": "unverified",
