  ...
  "rated": [
    {
      ...
      "subs": {
        ...
        "估值": [
          65,
          "PE 25–40 中高,已反映成長預期(PE 31.9);此為估值面,非買賣建議。"
        ],
        "動能": [
          85,
      ...
      "explain": {
        ...
        "valuation": "PE 31.9 中高(25–40),已反映不少成長預期,進場挑時機。",
    ...
    },
    {
      ...
      "explain": {
        ...
        "valuation": "PE 70.2 偏高(>40),市場給很高成長期待;成長不如預期回檔會兇。 不過它月營收年增 44%、成長很快——高成長配高本益比未必真的貴,這要靠 PEG(本益成長比)判斷,目前資料還不夠算,先別只看 PE 就說太貴。",
  ...
  "unrated": [
    {
      ...
      "subs": {
        ...
        "估值": [
          40,
          "PE>40 偏高,成長不如預期回檔風險大(PE 80.8);此為估值面,非買賣建議。"
        ],
        "動能": [
          85,
      ...
      "blockers": [
        "pb(來源A 官方PB(BWIBBU)=4.88 / 來源B 股價÷每股淨值=5.36)"
      ],
      "verify_summary": {
        "price": "verified",
        "eps": "verified",
      ...
      "rev_month": "2026-05",
      "explain": {
        "summary": "臻鼎:本業有賺、財務還算穩,但有一兩個指標普通,月營收還在高速成長(最新月年增 37%),但目前股價偏貴(本益比 81 倍),等於先付了很多未來的成長;一旦成長不如預期,容易回檔。",
        "health": [
          {
            "name": "毛利率",
            "val": "21.6%",
        ...
        "valuation": "PE 80.8 偏高(>40),市場給很高成長期待;成長不如預期回檔會兇。 不過它月營收年增 37%、成長很快——高成長配高本益比未必真的貴,這要靠 PEG(本益成長比)判斷,目前資料還不夠算,先別只看 PE 就說太貴。",
    ...
    },
    {
      ...
      "subs": {
        ...
        "估值": [
          40,
          "PE>40 偏高,成長不如預期回檔風險大(PE 105.2);此為估值面,非買賣建議。"
        ],
        "動能": [
          100,
      ...
      "blockers": [
        "pb(來源A 官方PB(BWIBBU)=29.54 / 來源B 股價÷每股淨值=31.)"
      ],
      "verify_summary": {
        "price": "verified",
        "eps": "verified",
      ...
      "rev_month": "2026-05",
      "explain": {
        "summary": "高力:本業有賺、財務還算穩,但有一兩個指標普通,月營收還在高速成長(最新月年增 40%),但目前股價偏貴(本益比 105 倍),等於先付了很多未來的成長;一旦成長不如預期,容易回檔。",
        "health": [
          {
            "name": "毛利率",
            "val": "29.0%",
        ...
        "valuation": "PE 105.2 偏高(>40),市場給很高成長期待;成長不如預期回檔會兇。 不過它月營收年增 40%、成長很快——高成長配高本益比未必真的貴,這要靠 PEG(本益成長比)判斷,目前資料還不夠算,先別只看 PE 就說太貴。",
    ...
    },
    {
      ...
      "subs": {
        ...
        "估值": [
          35,
          "虧損/獲利不穩,改看 PB:PB>6 很高,多為未來預期(PB 8.53)。"
        ],
        "動能": [
          55,
      ...
      "rev_month": "2026-05",
      "explain": {
        "summary": "訊芯:賺錢能力或財務結構有明顯弱點,月營收溫和成長(年增 5%),由於獲利不穩,改用股價淨值比看:目前 8.5 倍(高,多在反映未來預期)。",
        "health": [
          {
            "name": "毛利率",
            "val": "12.0%",
        ...
        "valuation": "PB 8.53 >1,市場願為它的未來多付錢(高於帳面淨值),成長股常見,別追過頭。",
